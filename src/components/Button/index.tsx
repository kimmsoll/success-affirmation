...
const Button = ({ onClick, style, text, icon }: Props) => {
  const buttonStyle = {
    ...
    lg_red: 'sm:w-36 w-full h-10 text-base bg-red-500 text-gray-100 font-semibold rounded-full hover:opacity-80',
    lg_green: 'sm:w-36 w-full h-10 text-base bg-green-500 text-gray-900 font-semibold rounded-full hover:opacity-80',
